...
async function executeTest() {
    ...
    let resultInfo = {};
    let feature = "admin-usuario/addBio.js";
    let pasos = ["Actions -- Clean up the bio and write",
                "Actions -- Fill username & password then log in",
                "Actions -- In the dashboard select the tab Staff and enter the user Ghost",
                "Actions -- Re-enter the Ghost user to verify the changes in the biography",
                "Actions -- We save the changes and return to the staff section"];
