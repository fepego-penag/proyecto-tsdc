  Feature: Login navigate Page editor, select new page, create page and edit page url
  
  @user1 @web
  Scenario: As the first user I want to be able to log into the application navigate Page editor, select new page, create page and edit page url
