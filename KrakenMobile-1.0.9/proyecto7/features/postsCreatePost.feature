  Feature: Login select Post button, select new post and create post
  
  @user1 @web
  Scenario: As the first user I want to be able to log into the application select post button, select new post and create post
  ...
  @user2 @web
  Scenario: As the second user I want to be able to log into the application select post button, select new post and create post
    Given I navigate to page "http://localhost:2368/ghost/#/signin"
    When I navigate to page "http://localhost:2368/ghost/#/signin/"
    Then I enter "ma.zapataf@uniandes.edu.co" into input field having id "ember8"
    Then I enter "misomazf88" into input field having id "ember10"
  ...
  @user3 @web
  Scenario: As the third user I want to be able to log into the application select post button, select new post and create post
    Given I navigate to page "http://localhost:2368/ghost/#/signin"
    When I navigate to page "http://localhost:2368/ghost/#/signin/"
    Then I enter "ma.zapataf@uniandes.edu.co" into input field having id "ember8"
    Then I enter "misomazf88" into input field having id "ember10"
