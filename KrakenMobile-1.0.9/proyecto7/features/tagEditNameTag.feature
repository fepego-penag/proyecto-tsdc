  Feature: Login navigate Tag editor, select new tag, create tag and edit name tag
  
  @user1 @web
  Scenario: As the first user I want to be able to log into the application navigate Tag editor, select new tag, create tag and edit name tag
  ...
  Scenario: As the first user I want to be able to log into the application navigate Tag editor, select new tag, create tag and edit name tag
    ...
    Then I click on element having css selector ".gh-btn.gh-btn-blue.gh-btn-icon.ember-view"
    Then I enter "$name_4" into input field having id "tag-name"
    Then I click on element having css selector ".gh-btn.gh-btn-blue.gh-btn-icon.ember-view"
    Then I navigate to page "http://localhost:2368/ghost/#/tags"
    Then I wait for 5 seconds
  ...
  Scenario: As the first user I want to be able to log into the application navigate Tag editor, select new tag, create tag and edit name tag
    ...
    Then I click on element having css selector ".gh-btn.gh-btn-blue.gh-btn-icon.ember-view"
    Then I enter "$name_6" into input field having id "tag-name"
    Then I click on element having css selector ".gh-btn.gh-btn-blue.gh-btn-icon.ember-view"
    Then I navigate to page "http://localhost:2368/ghost/#/tags"
    Then I wait for 5 seconds