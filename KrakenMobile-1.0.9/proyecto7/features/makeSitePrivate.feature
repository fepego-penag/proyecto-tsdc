  Feature: Login select general administration button and make private site
  
  @user1 @web
  Scenario: As the first user I want to be able to log into the application and make private site 
