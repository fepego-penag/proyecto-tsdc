  Feature: Login navigate Tag editor, select new tag, create tag and edit description tag
  
  @user1 @web
  Scenario: As the first user I want to be able to log into the application navigate Tag editor, select new tag, create tag and edit description tag
    ...
    Then I enter "$name_2" into input field having id "tag-description"
    Then I click on element having css selector ".gh-btn.gh-btn-blue.gh-btn-icon.ember-view"
    Then I navigate to page "http://localhost:2368/ghost/#/tags"
  ...
  Scenario: As the first user I want to be able to log into the application navigate Tag editor, select new tag, create tag and edit description tag
    ...
    Then I click on element having css selector ".gh-btn.gh-btn-blue.gh-btn-icon.ember-view"
    Then I enter "$name_4" into input field having id "tag-description"
    Then I click on element having css selector ".gh-btn.gh-btn-blue.gh-btn-icon.ember-view"
    Then I navigate to page "http://localhost:2368/ghost/#/tags"
    Then I wait for 5 seconds
