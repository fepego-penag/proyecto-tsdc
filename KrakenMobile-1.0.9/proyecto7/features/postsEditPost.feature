  Feature: Login select Post button, select new post and create post and edit post
  
  @user1 @web
  Scenario: As the first user I want to be able to log into the application select post button, select new post create post and edit post
    ...
    Then I enter "$name_2" into input field having css selector ".post-setting-slug.ember-text-field.gh-input.ember-view"
  ...
  @user2 @web
  Scenario: As the second user I want to be able to log into the application select post button, select new post create post and edit post
    Given I navigate to page "http://localhost:2368/ghost/#/signin"
    When I navigate to page "http://localhost:2368/ghost/#/signin/"
    Then I enter "ma.zapataf@uniandes.edu.co" into input field having id "ember8"
    Then I enter "misomazf88" into input field having id "ember10"
    ...
    Then I wait for 5 seconds
    Then I click on element having css selector ".post-settings"
    Then I enter "$name_4" into input field having css selector ".post-setting-slug.ember-text-field.gh-input.ember-view"
    Then I click on element having css selector ".close.settings-menu-header-action"
    Then I click on element having css selector ".ember-view.ember-basic-dropdown-trigger.gh-btn.gh-btn-outline.gh-publishmenu-trigger"
    Then I click on element having css selector ".gh-btn.gh-btn-blue.gh-publishmenu-button.gh-btn-icon.ember-view"
    Then I wait for 5 seconds
  ...
  @user3 @web
  Scenario: As the third user I want to be able to log into the application select post button, select new post create post and edit post
    Given I navigate to page "http://localhost:2368/ghost/#/signin"
    When I navigate to page "http://localhost:2368/ghost/#/signin/"
    Then I enter "ma.zapataf@uniandes.edu.co" into input field having id "ember8"
    Then I enter "misomazf88" into input field having id "ember10"
    ...
    Then I wait for 5 seconds
    Then I click on element having css selector ".post-settings"
    Then I enter "$name_6" into input field having css selector ".post-setting-slug.ember-text-field.gh-input.ember-view"
    Then I click on element having css selector ".close.settings-menu-header-action"
    Then I click on element having css selector ".ember-view.ember-basic-dropdown-trigger.gh-btn.gh-btn-outline.gh-publishmenu-trigger"
    Then I click on element having css selector ".gh-btn.gh-btn-blue.gh-publishmenu-button.gh-btn-icon.ember-view"
    Then I wait for 5 seconds