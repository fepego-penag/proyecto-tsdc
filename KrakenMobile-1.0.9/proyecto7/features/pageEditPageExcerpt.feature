  Feature: Login navigate Page editor, select new page, create page and edit page Excerpt
  
  @user1 @web
  Scenario: As the first user I want to be able to log into the application navigate Page editor, select new page, create page and edit page Excerpt
    ...
    Then I enter "$name_2" into input field having id "custom-excerpt"
  ...
  Scenario: As the first user I want to be able to log into the application navigate Page editor, select new page, create page and edit page Excerpt
    ...
    Then I wait for 5 seconds
    Then I click on element having css selector ".post-settings"
    Then I enter "$name_4" into input field having id "custom-excerpt"
    Then I click on element having css selector ".close.settings-menu-header-action"
    Then I click on element having css selector ".ember-view.ember-basic-dropdown-trigger.gh-btn.gh-btn-outline.gh-publishmenu-trigger"
    Then I click on element having css selector ".gh-btn.gh-btn-blue.gh-publishmenu-button.gh-btn-icon.ember-view"
    Then I wait for 5 seconds
  ...
  Scenario: As the first user I want to be able to log into the application navigate Page editor, select new page, create page and edit page Excerpt
    ...
    Then I wait for 5 seconds
    Then I click on element having css selector ".post-settings"
    Then I enter "$name_6" into input field having id "custom-excerpt"
    Then I click on element having css selector ".close.settings-menu-header-action"
    Then I click on element having css selector ".ember-view.ember-basic-dropdown-trigger.gh-btn.gh-btn-outline.gh-publishmenu-trigger"
    Then I click on element having css selector ".gh-btn.gh-btn-blue.gh-publishmenu-button.gh-btn-icon.ember-view"
    Then I wait for 5 seconds